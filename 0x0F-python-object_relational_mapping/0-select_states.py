...
if __name__ == '__main__':
    ...
    #   port: The port number on which the MySQL server is listening (default is 3306 for MySQL).
    ...
    #   charset: The character set to use for communication with the MySQL database (default is "utf8").
